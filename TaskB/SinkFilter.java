...
public class SinkFilter extends FilterFramework {
    ...
    public static class AsteriskInput extends BaseInput {
    ...
    public void run() {
        ...
        AsteriskInput asteriskInput = new AsteriskInput();
        ...
        while (true) {
            try {
                ...
                if (id == 0) {
                    ...
                    ///Temperature
                    asteriskInput.setTemperature(Double.longBitsToDouble(measurement));


                } else if (id == 2) {

                    asteriskInput.setAltitude(Double.longBitsToDouble(measurement));

                } else if (id == 3) {

                    asteriskInput.setPressure(Double.longBitsToDouble(measurement));

                } else if (id == 6) {
                    asteriskInput.setAsterisk(Double.longBitsToDouble(measurement));
                    asteriskInput.print();
                }
            ...
            /*******************************************************************************
             *	The EndOfStreamExeception below is thrown when you reach end of the asteriskInput
