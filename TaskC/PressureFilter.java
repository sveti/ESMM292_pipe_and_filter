...
public class PressureFilter extends FilterFramework{
    ...
    public class Input{
                ...
                throws IOException
        {
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("WildPointsPressure.dat", true));
        ...
        public Input(Long time, Long velocity, Long temperature, Long altitude, Double pressure, Long attitude, Boolean asterix) {
            this.time = time;
            this.velocity = velocity;
            this.temperature = temperature;
            this.altitude = altitude;
            ...
            try
            {
                ...
                if(id == 5) {
                    ...
                    if (input.getPressure() < minWildPoint || input.getPressure() > maxWildPoint) {
                        ...
                        Input inputForArray = new Input(input.getTime(), input.getVelocity(),input.getTemperature(),input.getAltitude(),input.getPressure(),input.getAttitude(),input.getAsterisk());
