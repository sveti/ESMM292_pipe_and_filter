...
public class AttitudeFilterInput {
    ...
    public AttitudeFilterInput(Long time, Long velocity, Long temperature, Long altitude, Double pressure, Double attitude, Double asterix, FilterFramework filterFramework) {
        this.time = time;
        this.velocity = velocity;
        this.temperature = temperature;
        this.altitude = altitude;
    ...
    public AttitudeFilterInput(FilterFramework filterFramework) {
        this.filterFramework = filterFramework;
    }
    ...
    public void putIntoStream() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (i == 0) {
                ...
                byte[] attitudeArray = ByteBuffer.allocate(MeasurementLength).putDouble(attitude).array();
                measurement = ByteBuffer.wrap(attitudeArray).getLong();
            }
         ...
         *************************************************************/
        Helper.writeDoubleIntoStream(IdLength, 6, MeasurementLength, asterisk, filterFramework);
